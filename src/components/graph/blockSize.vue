            ...
            <Collapse>
                <Panel name="1" style="font-size: 14px">
                    ...
                    <p slot="content" style="font-size: 16px;">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;从最一开始的几天产生一个区块，到现在的一天产生多个区块，这其中所容纳的交易信息也不在一个数量级上，所要存储的数据也相差甚远。按照摩尔定律来说，当价格不变时，集成电路上可容纳的元器件的数目，约每隔18-24个月便会增加一倍，性能也将提升一倍。换言之，每一美元所能买到的电脑性能，将每隔18-24个月翻一倍以上。这一定律揭示了信息技术进步的速度，有需求才会有供给，这也就意味着人们产生的信息量已经达到一定的程度从而需要更强大的硬件设备来支撑，而当技术水平确实提升到同一层级或者以上时，详细的数据信息所能反馈回来的就是这样一种"指数爆炸"的数据形态。</p>
                </Panel>
            </Collapse>
        </row>
    </div>
